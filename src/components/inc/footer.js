      ...
      <div className="container">
        <div className="footer-wrapper">
          ...
          <div className="socials">
            ...
            <a href="http://facebook.com/dinakajoy" target="_blank" rel="noopener noreferrer"><i className="fa fa-facebook"></i></a>
            <a href="https://stackoverflow.com/users/10469483/dinakajoy" target="_blank" rel="noopener noreferrer"><i className="fa fa-stack-overflow"></i></a>
          </div>
        </div>
      </div>
    </footer>
